...
//=============================================================================
//  ѕристартовый тест пина RX дл€ сброса конфигурации
//=============================================================================
...
void ICACHE_FLASH_ATTR test_pin_clr_wifi_config(void)
{
	...
	set_uartx_invx(UART0, ucfg.cfg.b.rxd_inv, UART_RXD_INV); // установить RX (GPIO3) в режим RX UART, если требуетс€
}

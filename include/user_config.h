...
#define USE_OVERLAY 5850 // включить в трансялцию возможность работы с оверлеями (максимальный размер кода оверлея)
#else
#define USE_OVERLAY 7424 // включить в трансялцию возможность работы с оверлеями (максимальный размер кода оверлея)
#endif
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
